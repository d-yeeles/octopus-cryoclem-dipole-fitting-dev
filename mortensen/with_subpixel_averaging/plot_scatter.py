...
model_names = ['subpixel1', 'subpixel3']
module_names = ['gaussian', 'hinterer']
file_paths = [
    'fitting_results_mortensen_subpixel1_tol1e3_E.py',
    'fitting_results_mortensen_subpixel1_tol1e3_E.py',
]
