...
file_paths = [
    'fitting_results_mortensen_subpixel1_tol1e3_F.py',
    'fitting_results_mortensen_subpixel1_tol1e3_F.py',
]
...
for i, inclination in enumerate([67.5]):
...
#            axs[j].text(x, y, f'{az:.1f}', fontsize=6, color='black', ha='left', va='bottom', alpha=0.7)
        ...
        axs[j].set_xlim(-max_val*1.1, max_val*1.1)
        axs[j].set_ylim(-max_val*1.1, max_val*1.1)
