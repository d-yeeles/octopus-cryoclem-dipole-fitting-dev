...
model_names = ['No fudge, powell', 'Fudge, powell', 'Always fudge, powell', 'Fudge, powell (more points)']
...
#            axs[i, 0].text(x, y, f"{label:.0f}°", fontsize=6, ha='right', va='bottom', color='black', alpha=0.7)
