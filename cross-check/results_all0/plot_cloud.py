...
file_paths = [
    'results_gaussian_on_hinterer_all0.py',
    'results_hinterer_on_hinterer_all0.py',
    'results_mortensen_on_hinterer_all0.py',
    'results_gaussian_on_mortensen_all0.py',
    'results_hinterer_on_mortensen_all0.py',
    'results_mortensen_on_mortensen_all0.py',
]
