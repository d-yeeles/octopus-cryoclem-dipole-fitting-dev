...
% Input params
frames_dir = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_inc68_testing/centred_360/';
...
for frame_index = 1:1%length(frame_paths)
    ...
    for blob_index = 1:length(x_array)
        ...
        % parEst.angleInclinationEstimate = angleInclination_array(blob_index); % given orientations in this case
        % tic;
        % fitResult = FitPSF_notpolar_PS(psfInit, parEst);
        % elapsed_time = toc;
        % fprintf('    Time to fit: %.2f seconds\n', elapsed_time);
        % angleInclination_estimate = parEst.angleInclinationEstimate;
...
% fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_inc68_testing/fitting_results_inc68_swarm.py';
% 
