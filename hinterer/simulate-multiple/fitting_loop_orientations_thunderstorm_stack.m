...
% 
% % Input params
% stack_dir = "/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/patching_tests/sims_23spot_large/";
% stack_path = stack_dir + "stack_all_simulations.tif";
% 
% % Thunderstorm localisations
% thunderstorm_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/patching_tests/sims_23spot_large/thunderstorm_results.csv';
% 
% % Output file
% fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/patching_tests/results_23spot_large.py';
% 
% % Model to use
% model = 'hinterer';
% 
...
% Output file
fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/patching_tests/results_real.py';
...
for frame_index = 1:number_of_frames%length(frame_paths)%randperm(length(frame_paths), 40)
    ...
    gt_x_px = zeros(length(positionX_nm_trues_frame), 1);
    gt_y_px = zeros(length(positionY_nm_trues_frame), 1);
    est_x_px = zeros(length(positionX_nm_estimates_frame), 1);
    est_y_px = zeros(length(positionY_nm_estimates_frame), 1);
    
    for i = 1:length(positionX_nm_trues_frame)
        % Convert from nm to pixels
        gt_x_px(i) = nm_to_px(positionX_nm_trues_frame(i), pixel_size_nm, image_width_px, 'x');
        gt_y_px(i) = nm_to_px(positionY_nm_trues_frame(i), pixel_size_nm, image_height_px, 'y');
