...
inclinations = 0:pi/18:pi;
azimuths = 0:2*pi/18:2*pi;
...
for inclination_index = 1:length(inclinations)
    ...
    for azimuth_index = 1:length(azimuths)
        ...
        output_path = sprintf('/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/sim_inc%i_az%i.tif', round(inclination_deg), round(azimuth_deg));
        ...
        data_output_path = sprintf('/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/params_inc%i_az%i.m', round(inclination_deg), round(azimuth_deg));

        fileID = fopen(data_output_path, 'w');
        fprintf(fileID, '%% ground truth for sim_inc%i_az%i.tif\n', round(inclination_deg), round(azimuth_deg));
