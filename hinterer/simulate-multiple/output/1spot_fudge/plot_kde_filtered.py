...
model_names = ['gaussian N=1e9 b=0', 'hinterer N=1e9 b=0', 'gaussian N=1e9 b=200', 'hinterer N=1e9 b=200']
module_names = ['gaussian_fm', 'gaussian_ps', 'hinterer_fm', 'hinterer_ps']
file_paths = [
    'background0/fitting_results_gaussian_highN.py',
    'background0/fitting_results_hinterer_highN.py',
    'background200/fitting_results_gaussian_highN.py',
    'background200/fitting_results_hinterer_highN.py',
]
...
for inclination in [0, 23, 45, 68, 90]:
    ...
    plt.tight_layout()
    output_filename = f"kde_filtered_plots_inc{round(inclination)}_highN.png"
