...
model_names = ['Original param, no fudge', 'Original param, fudge', 'Reparam, no fudge', 'Reparam, fudge']
...
#        for x, y, label in zip(filtered_para, filtered_perp, filtered_az_err):
#            axs[i, 1].text(x, y, f"{label:.2f}", fontsize=6, ha='right', va='bottom', color='black', alpha=0.7)
...
#        # Add text labels showing az_est
#        for x, y, label in zip(filtered_para, filtered_perp, filtered_az_err):
#            axs[i, 2].text(x, y, f"{label:.2f}", fontsize=6, ha='right', va='bottom', color='black', alpha=0.7)
