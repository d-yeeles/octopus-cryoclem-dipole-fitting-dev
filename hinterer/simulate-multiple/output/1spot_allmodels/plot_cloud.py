...
model_names = ['hinterer on hinterer', 'mortensen on mortensen']
file_paths = [
    './fitting_results_hinterer_68.py',
    './fitting_results_mortensen_68_B.py',
]
...
#            axs[i, 0].annotate(inc_label, (x, y), fontsize=6, color='black')
        ...
        axs[i, 0].set_xlim(-20, 20)#(-max_val*1.1, max_val*1.1)
        axs[i, 0].set_ylim(-20, 20)#(-max_val*1.1, max_val*1.1)
