...
model_names = ['gaussian, 2000 photons, 1800 points', 'hinterer, 2000 photons, 1800 points', 'mortensen, 2000 photons, 180 points']
...
for inclination in [0]:#[23, 45, 68]:
    ...
    for i, dataset in enumerate(datasets):
        ...
        axs[i, 0].set_xlim(-40, 40)#(-max_val*1.1, max_val*1.1)
        axs[i, 0].set_ylim(-40, 40)#(-max_val*1.1, max_val*1.1)
