...
model_names = ['gaussian 1e9 photons', 'hinterer 1e9 photons', 'mortensen 1e9 photons']
module_names = ['gaussian', 'hinterer', 'mortensen']
file_paths = [
    '../../1spot_finaltest/fitting_results_gaussian_highN.py',
    '../../1spot_finaltest/fitting_results_hinterer_highN.py',
    'fitting_results_mortensen_highN_theta45.py',
]
...
for inclination in [45]:#[0, 23, 45, 68, 90]:
