...
model_names = ['gaussian highN photons', 'hinterer highN photons', 'mortensen highN photons']
module_names = ['gaussian', 'hinterer', 'mortensen']
file_paths = [
    '../../../1spot_finaltest/background0/fitting_results_gaussian_highN.py',
    '../../../1spot_finaltest/background0/fitting_results_hinterer_highN.py',
...
for azimuth in [0, 45, 90, 135, 180]:
    ...
    for i, dataset in enumerate(datasets):
        ...
        dataset_inc = dataset[abs(dataset['inc_tru'] - azimuth) <= 5]
    ...
    plt.tight_layout()
    output_filename = f"kde_filtered_plots_az{round(azimuth)}.png"
