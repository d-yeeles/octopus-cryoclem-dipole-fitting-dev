...
model_names = ['hinterer lowN noise=0', 'hinterer lowN noise=0', 'hinterer lowN noise=200, previous', 'hinterer lowN noise=200, new']
module_names = ['gaussian_fm', 'gaussian_ps', 'hinterer_fm', 'hinterer_ps']
file_paths = [
    'fitting_results_hinterer_lowN_background0.py',
    'fitting_results_hinterer_lowN_background0.py',
    'fitting_results_hinterer_lowN_background200_no_noise_est.py',
    'fitting_results_hinterer_lowN_background200_noise_est.py',
]
...
for i, dataset in enumerate(datasets):
    ...
    if os.path.exists(file_path):
        ...
        newdata = pd.DataFrame({
                ...
                "para_err": compute_para_perp(module.x_err, module.y_err, module.inc_tru, module.az_tru)[0],
                "perp_err": compute_para_perp(module.x_err, module.y_err, module.inc_tru, module.az_tru)[1],
