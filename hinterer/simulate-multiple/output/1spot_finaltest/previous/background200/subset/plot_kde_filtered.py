...
model_names = ['hinterer lowN noise=mixed (old)', 'hinterer lowN noise=0', 'hinterer lown noise=200', 'hinterer lowN noise=mixed']
...
file_paths = [
    ...
    'fitting_results_hinterer_lowN_background200.py',
    'fitting_results_hinterer_lowN_background200.py',
]
