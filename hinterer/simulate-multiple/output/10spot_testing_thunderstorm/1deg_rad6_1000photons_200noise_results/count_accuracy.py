...
pd.DataFrame(correct).to_csv('TP_gaussian_radius1950.csv', index=False)
pd.DataFrame(false_positives).to_csv('FP_gaussian_radius1950.csv', index=False)
pd.DataFrame(false_negatives).to_csv('FN_gaussian_radius1950.csv', index=False)
...
pd.DataFrame(correct).to_csv('TP_hinterer_radius1950.csv', index=False)
pd.DataFrame(false_positives).to_csv('FP_hinterer_radius1950.csv', index=False)
pd.DataFrame(false_negatives).to_csv('FN_hinterer_radius1950.csv', index=False)
