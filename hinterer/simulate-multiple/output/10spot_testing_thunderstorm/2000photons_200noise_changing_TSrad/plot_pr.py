...
for radius in radii:
    tp_file = f"count_results/TP_gaussian_rad{radius}.csv"
    fp_file = f"count_results/FP_gaussian_rad{radius}.csv"
    fn_file = f"count_results/FN_gaussian_rad{radius}.csv"
...
for radius in radii:
    tp_file = f"count_results/TP_hinterer_rad{radius}.csv"
    fp_file = f"count_results/FP_hinterer_rad{radius}.csv"
    fn_file = f"count_results/FN_hinterer_rad{radius}.csv"
