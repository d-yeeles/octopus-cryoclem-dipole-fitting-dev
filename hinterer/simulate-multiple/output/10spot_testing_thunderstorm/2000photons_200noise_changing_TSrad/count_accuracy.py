...
thunderstorm_df = pd.read_csv('TS_results/thunderstorm_results_gaussian_rad12.csv')
...
pd.DataFrame(correct).to_csv('count_results/TP_gaussian_rad12.csv', index=False)
pd.DataFrame(false_positives).to_csv('count_results/FP_gaussian_rad12.csv', index=False)
pd.DataFrame(false_negatives).to_csv('count_results/FN_gaussian_rad12.csv', index=False)





thunderstorm_df = pd.read_csv('TS_results/thunderstorm_results_hinterer_rad12.csv')
...
pd.DataFrame(correct).to_csv('count_results/TP_hinterer_rad12.csv', index=False)
pd.DataFrame(false_positives).to_csv('count_results/FP_hinterer_rad12.csv', index=False)
pd.DataFrame(false_negatives).to_csv('count_results/FN_hinterer_rad12.csv', index=False)
