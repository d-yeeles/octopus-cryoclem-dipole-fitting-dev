...
basePath = "/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/10spot_testing_thunderstorm/2000photons_200noise_with_more_overlaps/dice/results/";
...
for (sigma = 1.0; sigma <= 4.0; sigma += 0.25) {
    ...
    for (fitradius = 1; fitradius <= 6; fitradius++) {
        ...
        filename = "thunderstorm-gaussian-sigma" + sigmaStr + "-fitrad" + fitradius + ".csv";
