...
subdirectory = "./"
for filename in os.listdir(subdirectory):
    if filename.startswith("fitting_results_hinterer_highN_swarm."):
...
subdirectory = "./"
for filename in os.listdir(subdirectory):
    if filename.startswith("fitting_results_hinterer_highN_swarm_corrected"):
...
for inclination in [68]:
    ...
    # Plots - zoom 2σ
    c = axs[0, 2].scatter(data_gaussian_fixed_inc["para_err"], data_gaussian_fixed_inc["perp_err"], s=2, c=data_hinterer_fixed_inc["az_tru"], cmap='hsv')
    cbar = fig.colorbar(c)
    ...
    axs[0, 2].set_xlim(mean1-2*max(std1, std2), mean1+2*max(std1, std2))
    axs[0, 2].set_ylim(mean2-2*max(std1, std2), mean2+2*max(std1, std2))
    ...
    axs[1, 2].set_xlim(mean1-2*max(std1, std2), mean1+2*max(std1, std2))
    axs[1, 2].set_ylim(mean2-2*max(std1, std2), mean2+2*max(std1, std2))
    ...
    axs[2, 2].set_xlim(mean1-2*min(std1, std2), mean1+2*min(std1, std2))
    axs[2, 2].set_ylim(mean2-2*min(std1, std2), mean2+2*min(std1, std2))
...
for inclination in [0, 23, 45, 68, 90]:
    ...
    axs[0, 2].scatter(data_gaussian_fixed_inc["az_tru"], data_gaussian_fixed_inc["az_err"], s=2)
    axs[0, 2].set_xlabel('$\phi$')
    axs[0, 2].set_ylabel('Δ$\phi$')
    axs[0, 2].set_title("Gaussian fmincon\nAzimuth residuals")

    axs[0, 3].scatter(data_gaussian_fixed_inc["az_tru"], data_gaussian_fixed_inc["obj_err"], s=2)
    axs[0, 3].set_xlabel('$\phi$')
    axs[0, 3].set_ylabel('Δ(obj func)')
    axs[0, 3].set_title("Gaussian fmincon\nObj func residuals")

    # Hinterer fmincon
    axs[1, 0].scatter(data_hinterer_fixed_inc["az_tru"], data_hinterer_fixed_inc["para_err"], s=2)
    axs[1, 0].set_xlabel('$\phi$')
    axs[1, 0].set_ylabel('Δ$\parallel$')
    axs[1, 0].set_title("hinterer fmincon\nParallel localisation residuals")
    ...
    axs[1, 2].scatter(data_hinterer_fixed_inc["az_tru"], data_hinterer_fixed_inc["az_err"], s=2)
    axs[1, 2].set_xlabel('$\phi$')
    axs[1, 2].set_ylabel('Δ$\phi$')
    axs[1, 2].set_title("hinterer fmincon\nAzimuth residuals")

    axs[1, 3].scatter(data_hinterer_fixed_inc["az_tru"], data_hinterer_fixed_inc["obj_err"], s=2)
    axs[1, 3].set_xlabel('$\phi$')
    axs[1, 3].set_ylabel('Δ(obj func)')
    axs[1, 3].set_title("hinterer fmincon\nObj func residuals")


    # Hinterer swarm
    axs[2, 0].scatter(data_hinterer_ps_fixed_inc["az_tru"], data_hinterer_ps_fixed_inc["para_err"], s=2)
    axs[2, 0].set_xlabel('$\phi$')
    axs[2, 0].set_ylabel('Δ$\parallel$')
    axs[2, 0].set_title("hinterer swarm\nParallel localisation residuals")
    ...
    axs[2, 2].scatter(data_hinterer_ps_fixed_inc["az_tru"], data_hinterer_ps_fixed_inc["az_err"], s=2)
    axs[2, 2].set_xlabel('$\phi$')
    axs[2, 2].set_ylabel('Δ$\phi$')
    axs[2, 2].set_title("hinterer swarm\nAzimuth residuals")

    axs[2, 3].scatter(data_hinterer_ps_fixed_inc["az_tru"], data_hinterer_ps_fixed_inc["obj_err"], s=2)
    axs[2, 3].set_xlabel('$\phi$')
    axs[2, 3].set_ylabel('Δ(obj func)')
    axs[2, 3].set_title("hinterer swarm\nObj func residuals")
