...
% 
% % Input params
% frames_dir = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_fudge/sims/';
% 
% % Output file
% fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_fudge/fitting_results_hinterer_reparam2_nofudge.py';
% 
% % Model to use
% model = 'hinterer';
% 
...
% 
%         fitResult = FitPSF_ML_reparam(psfInit, parEst, model);
% 
...
% 
% % Output file
% fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_fudge/fitting_results_hinterer_noreparam_fudge.py';
% 
% % Model to use
% model = 'hinterer';
% 
...
%         clear par.nPhotons; % Don't let it know number of photons in advance
% 
%         fitResult = FitPSF_ML_noreparam(psfInit, parEst, model);
% 
...
%         positionX_nm_estimate = fitResult.estimatesPositionDefocus.ML(1);
%         positionY_nm_estimate = fitResult.estimatesPositionDefocus.ML(2);
%         photons_estimate = fitResult.estimatesPositionDefocus.ML(6);
%         % objective_function_estimate = fitResult.estimatesPositionDefocus.ML(8);
% 
%         % % Now we need the value of the objective function at ground truth
%         % ground_truth_params = [positionX_nm_array(blob_index), positionY_nm_array(blob_index), 0, angleInclination_array(blob_index), angleAzimuth_array(blob_index)];
...
% Output file
fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_fudge/fitting_results_hinterer_reparam2d_allfudge.py';
...
for frame_index = 1:length(frame_paths)%randperm(length(frame_paths), 40)
    ...
    for blob_index = 1:length(x_array)
        ...
        parEst.parameterBounds.newangle3 = [-1, 1];
        ...
        parEst.parameterStartValues.newangle3 = 2*(rand()-0.5);
        ...
        angleInclination_estimate = 0.5*acos(fitResult.estimatesPositionDefocus.ML(6));
