...
% Input params
frames_dir = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_finaltest/subset/sims_lowN_background200/';

% Output file
fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_finaltest/subset/fitting_results_hinterer_lowN_background200_no_noise_est.py';
...
for frame_index = 1:length(frame_paths)%randperm(length(frame_paths), 40)
    ...
    for blob_index = 1:length(x_array)
        ...
        % Give it a background noise estimate
        % parEst.noiseEstimate = psfInit.backgroundNoise;
