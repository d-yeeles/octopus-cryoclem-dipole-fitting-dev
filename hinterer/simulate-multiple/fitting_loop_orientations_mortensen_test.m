...
% Input params
frames_dir = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_mortensen/sims_lowN/';

% Output file
fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_mortensen/fitting_results_hinterer2.py';
...
for frame_index = 1:length(frame_paths)%randperm(length(frame_paths), 40)
    ...
    psf_image = readmatrix(frame_path);
...
% Output file
fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer/simulate-multiple/output/1spot_mortensen/fitting_results_gaussian.py';
