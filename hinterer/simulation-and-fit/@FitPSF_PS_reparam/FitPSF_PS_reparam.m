classdef FitPSF_PS_reparam
    ...
    methods
        function obj = FitPSF_PS_reparam(psf, par)
            if nargin > 1
                obj = setInputParameters('FitPSF_PS_reparam', obj, par);
            end
            if nargin > 0
                obj.psf = psf;
                obj.image = psf.image;
        ...
        function estimatesPositionDefocus = fitting(obj)
            parPsfEstimate = FitPSF_PS_reparam.readParametersEstimate(obj.psf);
