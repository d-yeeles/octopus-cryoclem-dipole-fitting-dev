classdef FitPSF_notpolar_global
    ...
    methods
        function obj = FitPSF_notpolar_global(psf, par)
            if nargin > 1
                obj = setInputParameters('FitPSF_notpolar_global', obj, par);
            end
            if nargin > 0
                obj.psf = psf;
                obj.image = psf.image;
        ...
        function estimatesPositionDefocus = fitting(obj)
            parPsfEstimate = FitPSF_notpolar_global.readParametersEstimate(obj.psf);
