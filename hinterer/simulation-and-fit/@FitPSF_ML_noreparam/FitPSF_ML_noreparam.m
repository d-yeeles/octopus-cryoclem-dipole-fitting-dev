classdef FitPSF_ML_noreparam
    ...
    methods
        function obj = FitPSF_ML_noreparam(psf, par, bfpType)
            if nargin > 2
            ...
            if nargin > 1
                obj = setInputParameters('FitPSF_ML_noreparam', obj, par);
            end
        ...
        function estimatesPositionDefocus = fitting(obj)
            parPsfEstimate = FitPSF_ML_noreparam.readParametersEstimate(obj.psf);
        ...
        function estimatesPositionDefocusLS = fitLeastSquaresPSF(obj, image, psfEstimate)
            ...
            lowerBounds = [xBounds(1), yBounds(1), defocusBounds(1), InclinationBounds(1), AzimuthBounds(1), photonsBounds(1)];
            upperBounds = [xBounds(2), yBounds(2), defocusBounds(2), InclinationBounds(2), AzimuthBounds(2), photonsBounds(2)];
        ...
        function estimatesPositionDefocusML = fitMaxLikelihoodPSF(obj, image, psfEstimate, startValues)
            ...
            condition1 = abs(firstAttempt(4) - pi/2) >= 0.1*pi/180; % if estimate is within 0.5 deg of 90
            ...
            if condition1% || condition2
                ...
                secondStartValues(5) = firstAttempt(5) - pi;
                ...
                thirdStartValues(4) = firstAttempt(4) - pi/2;
                ...
                fourthStartValues(4) = firstAttempt(4) - pi/2;
                fourthStartValues(5) = firstAttempt(5) - pi;
        ...
        function currentFitPSF = createFitPSF(obj, psfEstimate, lateralPositionAndDefocus)
            ...
            inclination = lateralPositionAndDefocus(4);
            azimuth = lateralPositionAndDefocus(5);
