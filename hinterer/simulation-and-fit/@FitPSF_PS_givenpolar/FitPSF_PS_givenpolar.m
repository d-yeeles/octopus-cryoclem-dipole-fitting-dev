classdef FitPSF_PS_givenpolar
    ...
    methods
        function obj = FitPSF_PS_givenpolar(psf, par)
            if nargin > 1
                obj = setInputParameters('FitPSF_PS_givenpolar', obj, par);
            end
            if nargin > 0
                obj.psf = psf;
                obj.image = psf.image;
        ...
        function estimatesPositionDefocus = fitting(obj)
            parPsfEstimate = FitPSF_PS_givenpolar.readParametersEstimate(obj.psf);
        ...
        function estimatesPositionDefocusPS = fitParticleSwarmPSF(obj, image, psfEstimate)
            ...
            [xGrid, yGrid, defocusGrid, azimuthGrid] = ndgrid(...
            ...
            initialSwarm = [xGrid(:), yGrid(:), defocusGrid(:),azimuthGrid(:)];
