classdef FitPSF_PS_givenpolar_gaussian
    ...
    methods
        function obj = FitPSF_PS_givenpolar_gaussian(psf, par)
            if nargin > 1
                obj = setInputParameters('FitPSF_PS_givenpolar_gaussian', obj, par);
            end
            if nargin > 0
                obj.psf = psf;
                obj.image = psf.image;
        ...
        function estimatesPositionDefocus = fitting(obj)
            parPsfEstimate = FitPSF_PS_givenpolar_gaussian.readParametersEstimate(obj.psf);
