...
run('/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer_octave/simulation-and-fit/matlab_octave_compatibility.m');
...
% Input params
frames_dir = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer_octave/simulate_multiple/output/1spot_finaltest/background0/sims_lowN/subset/';

% Output file
fitting_results_path = '/home/tfq96423/Documents/cryoCLEM/dipole-issue/fixed-dipole-issue/hinterer_octave/simulate-multiple/output/1spot_finaltest/background0/fitting_results_hinterer_lowN_inc68.py';
...
for frame_index = 1:length(frame_paths)%randperm(length(frame_paths), 40)
    ...
    par.pixelSensitivityMask = ones(9); % Using this instead for Octave
